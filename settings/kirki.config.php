...
function getbowtied_customizer( $wp_customize ) {
	...
	$wp_customize->add_panel( 'panel_header', array(
		'title'          => esc_html__( 'Header', 'rebell' ),
		'priority'       => 5,
	...
	$wp_customize->add_panel( 'panel_shop', array(
		'title'          => esc_html__( 'Shop', 'rebell' ),
		'priority'       => 6,
		'capability'     => 'edit_theme_options',
	) );

	$wp_customize->add_panel( 'panel_blog', array(
		'title'          => esc_html__( 'Blog', 'rebell' ),
		'priority'       => 8,
		'capability'     => 'edit_theme_options',
	) );
}
...
if ( class_exists( 'Kirki' ) ) {
	...
	Kirki::add_section( 'header_style', array(
		'title'          => esc_attr__('Header Styles', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'header_elements', array(
		'title'          => esc_attr__( 'Header Elements', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'top_bar', array(
		'title'          => esc_attr__( 'Top Bar', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'sticky_header', array(
		'title'          => esc_attr__( 'Sticky Header', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'search', array(
		'title'          => esc_attr__( 'Search', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'          => 'panel_header',
	) );
	...
	Kirki::add_section( 'footer', array(
		'title'          => esc_attr__( 'Footer', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
	) );
	...
	Kirki::add_section( 'blog_archive', array(
		'title'          => esc_attr__( 'Blog Posts Archive', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'			 => 'panel_blog'
	) );
	...
	Kirki::add_section( 'single_post', array(
		'title'          => esc_attr__( 'Single Post', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'			 => 'panel_blog'
	) );
	...
	Kirki::add_section( 'shop_layout', array(
		'title'          => esc_attr__( 'Shop Layout', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'			 => 'panel_shop'
	) );
	...
	Kirki::add_section( 'product_card', array(
		'title'          => esc_attr__( 'Product Card', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'			 => 'panel_shop'
	) );
	...
	Kirki::add_section( 'shop_notifications', array(
		'title'          => esc_attr__( 'Shop Notifications', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'			 => 'panel_shop'
	) );
	...
	Kirki::add_section( 'product_badges', array(
		'title'          => esc_attr__( 'Product Badges', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'			 => 'panel_shop'
	) );
	...
	Kirki::add_section( 'mobile_settings', array(
		'title'          => esc_attr__( 'Mobile Settings', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'			 => 'panel_shop'
	) );
	...
	Kirki::add_section( 'catalog_mode', array(
		'title'          => esc_attr__( 'Catalog Mode', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
		'panel'			 => 'panel_shop'
	) );
	...
	Kirki::add_section( 'product', array(
		'title'          => esc_attr__( 'Product Page', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
	) );

	Kirki::add_section( 'styling', array(
		'title'          => esc_attr__( 'Styling', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
	) );

	Kirki::add_section( 'fonts', array(
		'title'          => esc_attr__( 'Fonts', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
	) );

	Kirki::add_section( 'custom_code', array(
		'title'          => esc_attr__( 'Custom Code', 'rebell' ),
		'priority'       => 10,
		'capability'     => 'edit_theme_options',
	) );
	 ...
	 */
		...
		/* Header Styles */
			...
			Kirki::add_field( 'rebell', array(
				'type'        => 'radio-image',
				'settings'    => 'main_header_layout',
				'label'       => esc_attr__( 'Header Layout', 'rebell' ),
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Navigation Font Size', 'rebell' ),
				'section'     => 'header_style',
				'default'     => '13',
				'choices'     => array(
						'min'  => 11,
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Navigation Font Color', 'rebell' ),
				'section'     => 'header_style',
				'default'     => '#000',
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Header Background Color', 'rebell' ),
				'section'     => 'header_style',
			...
			Kirki::add_field( 'rebell', array(
			    ...
			    'label'       => esc_html__( 'Spacing Above the Logo', 'rebell' ),
			    'section'     => 'header_style',
			    'default'     => 20,
			    'priority'    => 10,
			    'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Spacing Below the Logo', 'rebell' ),
				'section'     => 'header_style',
				'default'     => 20,
				'priority'    => 10,
				'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Header Width', 'rebell' ),
				'section'     => 'header_style',
				'default'     => 'custom',
				'priority'    => 10,
				'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Custom Max Width', 'rebell' ),
				'section'     => 'header_style',
				'default'     => 1680,
				'priority'    => 10,
				'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Transparent Header', 'rebell' ),
				'section'     => 'header_style',
				'default'     => false,
				'description' => '<span class="dashicons dashicons-editor-help"></span><a target="_blank" href="https://rebell.wp-theme.help/hc/en-us/articles/206678899">Working with Header Transparency</a>',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Default Transparency Color Scheme', 'rebell' ),
				'section'     => 'header_style',
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Text / Icon Color', 'rebell' ),
				'section'     => 'header_style',
				'default'     => '#fff',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Logo Light', 'rebell' ),
				'section'     => 'header_style',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Logo Dark', 'rebell' ),
				'section'     => 'header_style',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Product Categories Transparency', 'rebell' ),
				'section'     => 'header_style',
		...
		/* Header Elements */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Wishlist Icon', 'rebell' ),
				'section'     => 'header_elements',
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Custom Wishlist Icon', 'rebell' ),
				'section'     => 'header_elements',
				'priority'    => 10,
				'active_callback'    => array(
					array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Shopping Cart Icon', 'rebell' ),
				'section'     => 'header_elements',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Custom Shopping Cart Icon', 'rebell' ),
				'section'     => 'header_elements',
				'priority'    => 10,
				'active_callback'    => array(
					array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Cart Icon Function', 'rebell' ),
				'section'     => 'header_elements',
				'default'     => '1',
				'priority'    => 10,
				'choices'     => array(
						'1'     => esc_attr__( 'Mini Cart', 'rebell' ),
						'2'     => esc_attr__( 'Link', 'rebell' ),
					),
				'active_callback'    => array(
					array(
						'setting'  => 'main_header_shopping_bag',
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Open Mini Cart On', 'rebell' ),
				'section'     => 'header_elements',
				'default'     => '1',
				'priority'    => 10,
				'choices'     => array(
						'1'     => esc_attr__( 'Click', 'rebell' ),
						'2'     => esc_attr__( 'Hover', 'rebell' ),
					),
				'active_callback'    => array(
					array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Mini Cart Message', 'rebell' ),
				'section'     => 'header_elements',
				'priority'    => 10,
				'active_callback'    => array(
					array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'My Account Icon', 'rebell' ),
				'section'     => 'header_elements',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Custom My Account Icon', 'rebell' ),
				'section'     => 'header_elements',
				'priority'    => 10,
				'active_callback'    => array(
					array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Search Icon', 'rebell' ),
				'section'     => 'header_elements',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Custom Search Icon', 'rebell' ),
				'section'     => 'header_elements',
				'priority'    => 10,
				'active_callback'    => array(
					array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Off-Canvas Drawer', 'rebell' ),
				'section'     => 'header_elements',
				'default'     => false,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Custom Off-Canvas Icon', 'rebell' ),
				'section'     => 'header_elements',
				'priority'    => 10,
				'active_callback'    => array(
					array(
		...
		/* Header Logo */
			...
			Kirki::add_field( 'rebell', array(
				'type'        => 'image',
				'settings'    => 'site_logo',
				'label'       => esc_html__( 'Your Logo', 'rebell' ),
				'section'     => 'header_logo',
				'priority'    => 10,
				'default'	  => get_template_directory_uri() . '/images/rebell-logo.png',
				'description' => wp_kses( __( '<span class="dashicons dashicons-editor-help"></span>Applied on Non-Transparent Headers. To upload a logo for a Tansparent Background go to <strong>Header Layout & Style</strong> section.', 'rebell' ), array( 'span' => array( 'class' => array() ), 'strong' => array() )),
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Alternative Logo', 'rebell' ),
				'section'     => 'header_logo',
				'priority'    => 10,
				'default'	  => get_template_directory_uri() . '/images/rebell-logo.png',
				'description' => wp_kses( __('<span class="dashicons dashicons-editor-help"></span>Used on the <strong>Sticky Header</strong> and <strong>Mobile Devices</strong>.', 'rebell' ), array( 'span' => array( 'class' => array() ), 'strong' => array() )),
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Logo Container Min Width', 'rebell' ),
				'section'     => 'header_logo',
				'priority'    => 10,
				'default'	  => 50,
				'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Logo Container Height', 'rebell' ),
				'section'     => 'header_logo',
				'priority'    => 10,
				'default'	  => 50,
				'choices'     => array(
		...
		/* Top Bar */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Top Bar', 'rebell' ),
				'section'     => 'top_bar',
				'default'     => false,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Top Bar Background Color', 'rebell' ),
				'section'     => 'top_bar',
				'default'     => '#333333',
				'priority'    => 10,
				'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Top Bar Text Color', 'rebell' ),
				'section'     => 'top_bar',
				'default'     => '#fff',
				'priority'    => 10,
				'active_callback'    => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Top Bar Text', 'rebell' ),
				'section'     => 'top_bar',
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Top Bar Navigation Position', 'rebell' ),
				'section'     => 'top_bar',
				'default' 	  => 'right',
				'priority'    => 10,
				'choices'	  => 
		...
		/* Sticky Header */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Sticky Header', 'rebell' ),
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Sticky Header Background Color', 'rebell' ),
				'section'     => 'sticky_header',
				'default'     => '#fff',
				'priority'    => 10,
				'active_callback'    => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Sticky Header Color', 'rebell' ),
				'section'     => 'sticky_header',
				'default'     => '#000',
				'priority'    => 10,
				'active_callback'    => array(
	 ...
	 */	
		/* Footer */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Footer Background Color', 'rebell' ),
				'section'     => 'footer',
				'default'     => '#f4f4f4',
				'priority'    => 10,
				'choices'	  => 
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Footer Text', 'rebell' ),
				'section'     => 'footer',
				'default'     => '#868686',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Footer Links', 'rebell' ),
				'section'     => 'footer',
				'default'     => '#000',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Copyright Footnote', 'rebell' ),
				'section'     => 'footer',
				'default' 	  => 'rebell - eCommerce WP Theme',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Collapsed Widget Area on Mobiles', 'rebell' ),
				'section'     => 'footer',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Back To Top Button', 'rebell' ),
				'section'     => 'footer',
				'default'     => false,
				'priority'    => 10,
			));
	 ...
	 */
		/* Blog Archive */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Blog Layout', 'rebell' ),
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Blog Sidebar', 'rebell' ),
				'section'     => 'blog_archive',
				'default'     => false,
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Blog Pagination Style', 'rebell' ),
				'section'     => 'blog_archive',
		...
		/* Single Post */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Content Width', 'rebell' ),
				'section'     => 'single_post',
				'default'     => 708,
				'priority'    => 10,
				'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Author', 'rebell' ),
				'section'     => 'single_post',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Categories', 'rebell' ),
				'section'     => 'single_post',
				'default'     => true,
				'priority'    => 10,
			));
	 ...
	 */
		/* Shop Layout */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Breadcrumbs', 'rebell' ),
				'section'     => 'shop_layout',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Sidebar Style', 'rebell' ),
				'section'     => 'shop_layout',
				'default'     => '1',
				'priority'    => 10,
				'choices'	  => 
					array(
						'0'		=> esc_html__('On Page', 'rebell'),
						'1'		=> esc_html__('Off-Canvas', 'rebell')
					)
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Pagination Style', 'rebell' ),
				'section'     => 'shop_layout',
				'priority'    => 10,
				'choices'	  =>
					array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Category Display Style', 'rebell' ),
				'section'     => 'shop_layout',
				'default'     => 'styled_grid',
				'priority'    => 10,
				'choices'	  => 
					array(
						'styled_grid'		=> esc_html__('Categories Grid', 'rebell'),
						'original_grid'		=> esc_html__('Thumbs', 'rebell')
					),
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Display Number of Products on Categories Grid', 'rebell' ),
				'section'     => 'shop_layout',
				'default'     => true,
				'priority'    => 10,
				'active_callback'    => array(
		...
		/* Product Card */
			...
			Kirki::add_field( 'rebell', array(
		        ...
		        'label'    	  	=> esc_attr__( 'Product Title Font Size (px)', 'rebell' ),
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Second Product Image on Hover', 'rebell' ),
				'section'     => 'product_card',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Rating Stars', 'rebell' ),
				'section'     => 'product_card',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Add to Cart Button Display', 'rebell' ),
				'section'     => 'product_card',
				'default'     => '1',
				'priority'    => 10,
				'choices'	  => 
					array(
						'1'		=> esc_html__('When Hovering', 'rebell'),
						'0'		=> esc_html__('At all Times', 'rebell')
					)
			));
			...
			Kirki::add_field( 'rebell', array(
				'type'        => 'toggle',
				'settings'    => 'quick_view',
				'label'       => esc_attr__( 'Quick View', 'rebell' ),
				'section'     => 'product_card',
				'default'     => false,
				'priority'    => 10,
			));
		...
		/* Shop Notifications */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Notification Style', 'rebell' ),
				'section'     => 'shop_notifications',
				'default'     => '1',
				'priority'    => 10,
				'choices'	  => 
					array(
						'1'		=> esc_html__('Animated', 'rebell'),
						'0'		=> esc_html__('Classic', 'rebell')
					)
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Animation', 'rebell' ),
				'section'     => 'shop_notifications',
				'default'     => '1',
				'priority'    => 10,
				'choices'	  => 
					array(
						'1'		=> esc_html__('Slide Out', 'rebell'),
						'0'		=> esc_html__('Always Visible', 'rebell')
					),
				'active_callback'    => array(
					array(
		...
		/* Product Badges */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_html__( 'Out of Stock Label', 'rebell' ),
				'description' => esc_html__('If you\'re using a multi language plugin we recommend leaving the default value.', 'rebell'),
			...
			Kirki::add_field( 'rebell', array(
				'type'        => 'text',
				'settings'    => 'sale_label',
				'label'       => esc_html__( 'Sale Label', 'rebell' ),
				'description' => esc_html__('If you\'re using a multi language plugin we recommend leaving the default value.', 'rebell'),
				'section'     => 'product_badges',
				'default'     => 'Sale!',
				'priority'    => 10
		...
		/* Mobile Settings */
		    ...
		    Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Number of Columns on Mobile', 'rebell' ),
		...
		/* Catalog Mode */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Catalog Mode', 'rebell' ),
				'section'     => 'catalog_mode',
				'default'     => false,
				'description' => wp_kses( __('<span class="dashicons dashicons-editor-help"></span>When enabled, the feature Turns Off the shopping functionality of WooCommerce.', 'rebell'), array( 'span' => array( 'class' => array() ) ) ),
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Predictive Search', 'rebell' ),
				'section'     => 'search',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Search Only in Product Titles', 'rebell' ),
				'section'     => 'search',
				'default'     => false,
				'priority'    => 10,
				'active_callback'    => array(
	 ...
	 */
		/* Product Page */
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Product Page Layout', 'rebell' ),
				'section'     => 'product',
				'default'     => 'default',
				'priority'    => 10,
				'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Product Quantity Style', 'rebell' ),
				'section'     => 'product',
				'default'     => 'default',
				'priority'    => 10,
				'choices'     => array(
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Product Gallery Zoom', 'rebell' ),
				'section'     => 'product',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Product Gallery Lightbox', 'rebell' ),
				'section'     => 'product',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Related Products', 'rebell' ),
				'section'     => 'product',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Number of Related Products', 'rebell' ),
				'section'     => 'product',
				'default'     => 4,
				'priority'    => 10,
				'choices'	  => 
			...
			Kirki::add_field( 'rebell', array(
				'type'        => 'toggle',
				'settings'    => 'review_tab',
				'label'       => esc_attr__( 'Review Tab', 'rebell' ),
				'section'     => 'product',
				'default'     => true,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Disable Out of Stock Variations', 'rebell' ),
				'section'     => 'product',
				'default'     => true,
				'description' => wp_kses( __("<span class='dashicons dashicons-editor-help'></span>The variations will be disabled in the attribute's options list.", 'rebell'), array( 'span' => array( 'class' => array() ) ) ),
				'priority'    => 10,
			));
	 ...
	 */
		/* Styling */
			...
			Kirki::add_field( 'rebell', array(
				'type'        => 'color',
				'settings'    => 'body_color',
				'label'       => esc_attr__( 'Body Text Color', 'rebell' ),
				'section'     => 'styling',
				'default'     => '#545454',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Headings Color', 'rebell' ),
				'section'     => 'styling',
				'default'     => '#000000',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				'type'        => 'color',
				'settings'    => 'main_color',
				'label'       => esc_attr__( 'Accent Color', 'rebell' ),
				'section'     => 'styling',
				'default'     => '#EC7A5C',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Body Background', 'rebell' ),
				'section'     => 'styling',
				'default'     => array('background-color' => '#FFFFFF'),
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Smooth Transition Between Pages', 'rebell' ),
				'section'     => 'styling',
				'default'     => 0,
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Off-Canvas Background Color', 'rebell' ),
				'section'     => 'styling',
				'default'     => '#ffffff',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Off-Canvas Headings Color', 'rebell' ),
				'section'     => 'styling',
				'default'     => '#000000',
				'priority'    => 10,
			));
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       => esc_attr__( 'Off-Canvas Text Color', 'rebell' ),
				'section'     => 'styling',
				'default'     => '#545454',
				'priority'    => 10,
			));
	 ...
	 */
		/* Fonts */
		    ...
		    Kirki::add_field( 'rebell', array(
		        ...
		        'label'    	  	=> esc_attr__( 'Main Font', 'rebell' ),
		        'description' 	=> wp_kses( __( '<span class="dashicons dashicons-editor-help"></span>Used for titles and Headings.', 'rebell' ), array( 'span' => array( 'class' => array() ) ) ),
		        'section'  		=> 'fonts',
		        'priority' 		=> 10,
		        'default'     => array(
		    ...
		    Kirki::add_field( 'rebell', array(
		        ...
		        'label'    	  	=> esc_attr__( 'Headings Font Size (px)', 'rebell' ),
		        'section'     	=> 'fonts',
		        'priority'    	=> 10,
		        'default'     	=> 23,
		        'choices'		=> 
			...
			Kirki::add_field( 'rebell', array(
				...
				'label'       	=> esc_attr__( 'Secondary Font', 'rebell' ),
		        'section'  	  	=> 'fonts',
		        'priority'    	=> 10,
		        'default'     => array(
			        'font-family'    => 'Radnika',
		    ...
		    Kirki::add_field( 'rebell', array(
		        ...
		        'label'    	  	=> esc_attr__( 'Body Font Size (px)', 'rebell' ),
		        'section'     	=> 'fonts',
		        'priority'    	=> 10,
		        'default'     	=> 16,
		        'choices'		=> 

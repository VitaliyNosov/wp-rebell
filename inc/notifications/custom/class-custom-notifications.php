...
class GBT_Custom_Notifications {
	...
	*/
	...
	public function gbt_cn_get_template() {
		...
		if ( isset($rebell_theme_options['notification_mode']) && 
			$rebell_theme_options['notification_mode'] == '1' && 
		isset($rebell_theme_options['notification_style']) && 
		$rebell_theme_options['notification_style'] == '0') {
			$slide_type = 'slide-in';
		}
	...
	*/
	...
	public function gbt_cn_enqueue_scripts() {
		...
		$localize_script = array(
			...
			'slide_out'			 => $rebell_theme_options['notification_style'],

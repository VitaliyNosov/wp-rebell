...
if( (isset($rebell_theme_options['breadcrumbs'])) && ($rebell_theme_options['breadcrumbs']) == "0" ) {
	$custom_styles .= '
...
if( isset($rebell_theme_options['product_quantity_style']) && $rebell_theme_options['product_quantity_style'] == "custom") {
	$custom_styles .= '
...
if ( (isset($rebell_theme_options['main_background']['background-color'])) ) {
	$quickview_bg = ', ' . esc_html($rebell_theme_options['main_background']['background-color']) . ' 70%';
}
...
if( isset($rebell_theme_options['notification_mode']) && $rebell_theme_options['notification_mode'] == '1' && isset($rebell_theme_options['notification_style']) && $rebell_theme_options['notification_style'] == '0') {
...
if( (isset($rebell_theme_options['catalog_mode'])) && ($rebell_theme_options['catalog_mode'] == 1) ) {
	$custom_styles .= '

...
if ( ! class_exists( 'GBTHELPERS' ) ) {
	class GBTHELPERS {
		...
		protected static $gbthemes = array( 'merchandiser', 'rebell', 'mrtailor', 'theretailer', 'thehanger' );
		...
		public static function envato_link() {
			switch ( self::theme_name() ) {
				case 'rebell':
				return 'https://themeforest.net/item/rebell-ecommerce-wp-theme-for-woocommerce/9553045';
				break;

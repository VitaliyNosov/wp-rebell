...
{
    add_meta_box( 'product_options_meta_box', esc_html__("Product Options","rebell"), 'product_options_meta_box_content', 'product', 'side', 'high' );
}
...
function product_options_meta_box_content()
{
    ...
    <p>
        ...
        <label for="product_full_screen_description_meta_box_check"><?php esc_html_e("Fullscreen Description", "rebell"); ?></label>
    </p>

...
function ocdi_import_files() {
  return array(
    array(
      ...
      'local_import_file'            => trailingslashit( get_template_directory() ) . 'inc/demo/rebell.wordpress.xml',
      // 'import_preview_image_url'     => 'http://import.getbowtied.com/rebell-v2/wp-content/themes/rebell/screenshot.png',
      //'import_notice'                => '',
      // 'preview_url'                  => 'http://import.getbowtied.com/rebell-v2/',
    ),
  );
}
...
function ocdi_plugin_page_setup( $default_settings ) {
  ...
  $default_settings['page_title']  = esc_html__( 'One Click Demo Import' , 'rebell' );
  $default_settings['menu_title']  = esc_html__( 'Import Demo Data' , 'rebell' );

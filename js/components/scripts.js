...
jQuery(function($) {
	...
	var minicart_product_img = $('.rebell-mini-cart .widget.woocommerce.widget_shopping_cart .widget_shopping_cart_content .cart_list.product_list_widget li.mini_cart_item .product-item-bg');

...
if ( is_active_sidebar( 'catalog-widget-area' ) && (isset($rebell_theme_options['sidebar_style'])) && ($rebell_theme_options['sidebar_style'] == "0") ) {
...
?>
	<div id="primary" class="content-area shop-page<?php echo esc_attr($shop_has_sidebar) ? ' shop-has-sidebar':'';?>">
	   ...
	   <?php if ( 
	   				...
	   				$page_title_option == 'on' || 
	   				($display_mode == 'both' && $rebell_theme_options['category_style'] != 'original_grid') ||
	   				$archive_description != ''
	   			) : ?> 
				<div class="row">
...
?>
				...
				<div class="large-12 large-centered columns">
					...
					<?php if ($display_mode == 'both' && $rebell_theme_options['category_style'] != 'original_grid') : ?>
						<?php if ($categories) : ?>
			...
			<div class="large-12 columns">
			   ...
			   <div class="before_main_content">
				...
				<div id="content" class="site-content" role="main">
					...
					<?php if ( $display_mode == 'subcategories' && $rebell_theme_options['category_style'] != 'original_grid' ) : ?>
							  ...
							  <div class="categories_grid">
								  ...
								  <?php foreach($categories as $category) : ?>
									  ...
									  <?php                        
										  ...
										  $cat_class = $rebell_theme_options['category_style'];
									  ?>
										  ...
										  <div class="category_grid_box">
											  ...
											  <a href="<?php echo get_term_link( $category->slug, 'product_cat' ); ?>" class="category_item">
												<span class="category_name"><?php echo esc_html($category->name); ?>
													...
													<?php if( isset($rebell_theme_options['categories_grid_count']) && $rebell_theme_options['categories_grid_count'] ) : ?>
					...
					<?php elseif ( $rebell_theme_options['category_style'] == 'original_grid' && ($display_mode == 'subcategories' || $display_mode == 'both')): ?>
						<?php if ($categories) : ?>
						  	<div class="row">
								<ul class="row products products-grid <?php rebell_loop_columns_class(); ?>">								  
									<?php foreach($categories as $category) : ?>
										<?php 
									  		$thumbnail_id = get_term_meta( $category->term_id, 'thumbnail_id', true );
											$image = wp_get_attachment_url( $thumbnail_id );

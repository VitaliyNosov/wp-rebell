...
while ( have_posts() ) : the_post();
	...
	global $post, $product, $rebell_theme_options;
            ...
            <div class="product_infos">
        		...
        		<?php do_action( 'woocommerce_single_product_summary_single_add_to_cart' ); ?>
	                ...
	                <div class="quickview-badges">
	                    <?php if ( (isset($rebell_theme_options['catalog_mode'])) && ($rebell_theme_options['catalog_mode'] == 0) ) : ?>
							<?php if ( !$product->is_in_stock() && !empty($rebell_theme_options['out_of_stock_label']) ) : ?>            
	                           <div class="out_of_stock_wrapper">          
	                               <div class="out_of_stock_badge_single <?php if (!$product->is_on_sale()) : ?>first_position<?php endif; ?>"><?php esc_html_e( $rebell_theme_options['out_of_stock_label'], 'woocommerce' ); ?> 
	                    ...
	                    <?php endif; ?>
		            	<?php 
		            		if ( (isset($rebell_theme_options['catalog_mode'])) && ($rebell_theme_options['catalog_mode'] == 0) ) {
